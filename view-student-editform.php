  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h1 class="modal-title fs-5" id="editCourseModalLabel<?php echo $student['student_id']; ?>">Edit Students</h1>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div class="modal-body">
          <form method="post" action="">
            <div class="mb-3">
              <label for="sName<?php echo $student['student_id']; ?>" class="form-label">Student Name</label>
              <input type="text" class="form-control" id="sName<?php echo $student['student_id']; ?>" name="sName" value="<?php echo $student['student_name']; ?>">
            </div>
            <div class="mb-3">
